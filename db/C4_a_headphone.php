...
$sql = "INSERT INTO C4_HC (uid, `HC-totalCorrect`, `HC-finishedTime` , `HC-inattention`, `HC-All-Data`) VALUES ('$uid', '$totalCorrect', '$finishedTime', '$inattention', '$HCAllData')";

// SQL - updating the data of status table 
$sql_udate_status = "UPDATE `C4_user-status` SET q1_HC = '1' WHERE uid = '$uid'";
$conn->query($sql_udate_status);


// close and heading to next page
$path = "../C4_2_listening_phase_radio.php";

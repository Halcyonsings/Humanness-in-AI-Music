...
// Insert profile data
$sql = "INSERT INTO `C3_user-profile` (uid, ip, browser, `time-start`, userObject, `inattention-P0`) VALUES ('$uid', '$ip', '$browser', '$start_time', '$user_object','$inattention')";

// initiating status table
$sql_status_init = "INSERT INTO `C3_user-status` (uid) VALUES ('$uid')";
$conn->query($sql_status_init);

// close and heading to next page
$path = "../C3_1_headphone.php";

...
$sql = "INSERT INTO C3_MP (uid, `AC-Response`,`MP-Response`, `MP-RT` ,`AC-startTime`, `MP-finishedTime`, `ACMP-inattetion`) VALUES ('$uid', '$AC_Response', '$MP_Response', '$MP_ResponseTime', '$startTime', '$finishedTime', '$inattention')";

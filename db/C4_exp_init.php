...
// Insert profile data
$sql = "INSERT INTO `C4_user-profile` (uid, ip, browser, `time-start`, `inattention-P0`) VALUES ('$uid', '$ip', '$browser', '$start_time','$inattention')";

// initiating status table
$sql_status_init = "INSERT INTO `C4_user-status` (uid) VALUES ('$uid')";
$conn->query($sql_status_init);

// close and heading to next page
$path = "../C4_1_headphone.php";

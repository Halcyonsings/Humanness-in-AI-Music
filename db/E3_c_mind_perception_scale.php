...
$sql = "INSERT INTO E3_MP (uid, `AC-Response`,`MP-Response`, `MP-RT`, `MP-finishedTime`, `ACMP-inattetion`) VALUES ('$uid', '$AC_Response', '$MP_Response', '$MP_ResponseTime', '$finishedTime', '$inattention')";


// SQL - updating the data of status table 
$sql_udate_status = "UPDATE `E3_user-status` SET q3_ACMP = '1' WHERE uid = '$uid'";
$conn->query($sql_udate_status);

// close and heading to next page
$path = "/~hsiang/E3_4_demographics.php";

...
$sql = "INSERT INTO N3_Listening (uid, `L-playTime`, `L-allAnswers`,`L-allRT`, `L-finishedTime`, `L-hurrySubject`, `L-inattention`, `L-reapeatedTimes`) VALUES ('$uid', '$playTime','$allAnswers', '$allRT', '$finishedTime', '$hurrySubject', '$inattention', '$repeated')";

// SQL - updating the data of status table 
$sql_udate_status = "UPDATE `N3_user-status` SET q2_L = '1' WHERE uid = '$uid'";
$conn->query($sql_udate_status);

// close and heading to next page
$path = "/~hsiang/N3_3_mind_perception_scale.php";
